  ...
  const experiences = [
    {
      ...
      type: "Full-time",
      description:
        "Developed automation testing initiatives for an fintech platform",
      achievements: [
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Developed automated testing solutions for high-traffic web application",
      achievements: [
    ...
    },
    {
      ...
      type: "Full-time",
      description:
        "Established testing processes and automation practices for a rapidly growing small company.",
      achievements: [
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A proven track record of delivering quality solutions across diverse
